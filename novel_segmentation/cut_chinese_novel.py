...
if __name__ == '__main__':
    ...
    parser.add_argument('--Chinese_novel_path', type=str, default=r'example/path/littprince_main_text.txt', help='Path to your .txt Chinese novel content')
    ...
    with open(args.Chinese_novel_path, encoding='utf-8') as file:
        ...
        save_to_xlsx(args.save_path, r'/result.xlsx', result)
        ...
        save_to_xlsx(args.save_path, r'example_name.xlsx', preface_text,
        ...
        for i, main_content_part in enumerate(main_content_parts):
            ...
            file_name = r'example_name_run_' + str(round(i + 1)) + '_display.xlsx'
        ...
        save_to_xlsx(args.save_path, r'/example_name.xlsx', result_without_punc[1:])
        seg = read_xlsx(args.save_path + r'/example_name.xlsx')
        ...
        save_to_xlsx(args.save_path, r'/example_name_preface.xlsx', preface_without_punc)

        for i, content_without_punc in enumerate(main_content_parts_without_punc):
            filename = r'/example_name_run_' + str(i+1) + '.xlsx'
